           ...
           body: Container(
             ...
             child: Column(
               children: <Widget>[
                 ...
                 _CalculatorKeyboard(onValueChange: _onValueChange),
                 SizedBox(
                   height: 80,
                 )
               ],
...
class _CalculatorKeyboard extends StatelessWidget {
  ...
  _CalculatorKeyboard({Key key, this.onValueChange}) : super(key: key);
